...
# ── Title overrides: keyword-forward, 30-60 chars, "{Topic} | Roadie Labs" ──
# Indexed by wp_id. Every entry in RACE_GUIDE_ENTRIES and MANUAL_ENTRIES
# should have a corresponding title here.

TITLE_MAP = {
    # ── Race Guide Pages ──
    4993: "Barry-Roubaix Race Guide | Roadie Labs",
    4994: "Belgian Waffle Ride Race Guide | Roadie Labs",
    4995: "Big Horn Gravel Race Guide | Roadie Labs",
    4996: "Big Sugar Race Guide | Roadie Labs",
    4997: "BWR Cedar City Race Guide | Roadie Labs",
    4998: "Crusher in the Tushar Race Guide | Roadie Labs",
    4999: "Dirty Reiver Race Guide | Roadie Labs",
    5000: "Gravel Locos Race Guide | Roadie Labs",
    5001: "Gravel Worlds Race Guide | Roadie Labs",
    5002: "Leadville 100 MTB Race Guide | Roadie Labs",
    5003: "Mid South Race Guide | Roadie Labs",
    5004: "Migration Gravel Race Guide | Roadie Labs",
    5005: "Ned Gravel Race Guide | Roadie Labs",
    5006: "Oregon Trail Gravel Race Guide | Roadie Labs",
    5007: "Rebecca's Private Idaho Race Guide | Roadie Labs",
    5008: "Rooted Vermont Race Guide | Roadie Labs",
    5009: "SBT GRVL Race Guide | Roadie Labs",
    5010: "Sea Otter Gravel Race Guide | Roadie Labs",
    5011: "Rad Dirt Fest Race Guide | Roadie Labs",
    5012: "The Rift Race Guide | Roadie Labs",
    5013: "Traka 360 Race Guide | Roadie Labs",
    5014: "Unbound 200 Race Guide | Roadie Labs",

    # ── Core Pages ──
    448: "Gravel Race Database & Training Plans | Roadie Labs",
    451: "Contact & Support | Roadie Labs",
    470: "The Ultimate Gravel Cycling Guide | Roadie Labs",
    5016: "Gravel Training Plans | Roadie Labs",
    5017: "Training Plan Questionnaire | Roadie Labs",
    5018: "Gravel Race Database | Roadie Labs",
    5042: "Gravel Cycling Resources | Roadie Labs",
    5043: "Gravel Cycling Coaching | Roadie Labs",
    5045: "Gravel Cycling Articles | Roadie Labs",

    # ── Training Content Pages ──
    5027: "Popular Gravel Training Plans | Roadie Labs",
    5029: "Anaerobic Assessment for Cycling | Roadie Labs",
    5030: "Training and Relationships | Roadie Labs",
    5031: "Aerobic Endurance Test | Roadie Labs",
    5032: "How to Improve Cycling Performance | Roadie Labs",
    5033: "Frequency, Duration & Intensity | Roadie Labs",
    5034: "TrainingPeaks Training Zones | Roadie Labs",
    5035: "Aerobic Threshold Assessment | Roadie Labs",
    5036: "How Much Faster Could You Be? | Roadie Labs",
    5037: "Custom Gravel Training Plans | Roadie Labs",
    5038: "Is Cycling Coaching Worth It? | Roadie Labs",
    5039: "Training Plans FAQ | Roadie Labs",

    # ── Standalone Race Pages ──
    5019: "Barry-Roubaix Gravel Race | Roadie Labs",
    5020: "SBT GRVL Steamboat Springs | Roadie Labs",
    5021: "Belgian Waffle Ride | Roadie Labs",
    5022: "Mid South Gravel Race | Roadie Labs",
    5023: "Unbound Gravel 200 Breakdown | Roadie Labs",
    5026: "Unbound 200 Gravel Race | Roadie Labs",
    5028: "Crusher in the Tushar | Roadie Labs",

    # ── Other Pages ──
    5024: "Gravel Cycling Services | Roadie Labs",
    5025: "Roadie Labs Values | Roadie Labs",
    5040: "TrainingPeaks User Guide | Roadie Labs",
    5041: "TrainingPeaks Athlete Guide | Roadie Labs",

    # ── Blog Posts: Race Reports ──
    1923: "Belgian Waffle Ride Race Report | Roadie Labs",
    1964: "Unbound 200 Race Report | Roadie Labs",
    2065: "Gunni Grinder Race Report | Roadie Labs",
    2209: "Red Granite Grinder Race Report | Roadie Labs",
    2324: "SBT GRVL Race Report | Roadie Labs",
    2790: "Iron Horse Classic Race Report | Roadie Labs",
    2844: "Red Granite Grinder Part Two | Roadie Labs",
    3203: "Unbound 200 Best Bike Split Pacing | Roadie Labs",
    3353: "CO2UT Race Report | Roadie Labs",
    3433: "Unbound 200 Clean Ride Report | Roadie Labs",
    3483: "Ned Gravel Race Report | Roadie Labs",
    3504: "FoCo Fondo Race Report | Roadie Labs",
    3520: "SBT GRVL Redemption Ride | Roadie Labs",
    3537: "Red Granite Grinder Part Three | Roadie Labs",
    3749: "Unbound 2024 Race Report | Roadie Labs",
    3796: "Big Horn Gravel Race Report | Roadie Labs",

    # ── Blog Posts: Tour of the Gila (2024) ──
    3631: "Tour of the Gila Stage 3 | Roadie Labs",
    3641: "Tour of the Gila Stage 2 | Roadie Labs",
    3653: "Tour of the Gila Stage 1 | Roadie Labs",
    3662: "Tour of the Gila Stage 4 | Roadie Labs",
    3673: "Tour of the Gila Stage 5 | Roadie Labs",

    # ── Blog Posts: Tour of the Gila (2023) ──
    3278: "Gila Tyrone Time Trial | Roadie Labs",
    3281: "Gila Inner Loop Road Race | Roadie Labs",
    3297: "Gila Silver City Criterium | Roadie Labs",
    3306: "Gila Monster Stage Report | Roadie Labs",
    3335: "Gila Mogollon Stage Report | Roadie Labs",

    # ── Blog Posts: The Double ──
    2552: "The Double: Day 1 | Roadie Labs",
    2563: "The Double: Day 2 | Roadie Labs",
    2592: "The Double: Day 3 | Roadie Labs",
    2608: "The Double: Day 4 | Roadie Labs",
    2623: "The Double: Day 5 | Roadie Labs",
    2635: "The Double: Day 6 | Roadie Labs",
    2649: "The Double: Day 8 | Roadie Labs",
    2663: "The Double: Day 9 | Roadie Labs",
    2673: "The Double: Day 10 | Roadie Labs",
    2684: "The Double: Day 11 | Roadie Labs",
    2696: "The Double: Day 12 | Roadie Labs",
    2716: "The Double: Day 13 | Roadie Labs",

    # ── Blog Posts: Training & Mindset ──
    2014: "Gravel Race Hydration Guide | Roadie Labs",
    2161: "Dopamine and Cycling Performance | Roadie Labs",
    2191: "Train Your Heart for Cycling | Roadie Labs",
    2298: "Cycling Goal Setting | Roadie Labs",
    2394: "Training Consistency | Roadie Labs",
    2414: "The Racing Mindset Switch | Roadie Labs",
    2445: "Your Frame of Reference | Roadie Labs",
    2469: "How to Do Cycling Workouts Right | Roadie Labs",
    2521: "HRV for Endurance Athletes | Roadie Labs",
    2904: "Athletic Advice BS Detector | Roadie Labs",
    2927: "Stop Sandbagging Your Goals | Roadie Labs",
    2942: "Holiday Training Guide | Roadie Labs",
    2956: "Masters Cycling Advantage | Roadie Labs",
    1269: "Beer and Cycling Performance | Roadie Labs",
    1431: "Cross-Training for Cyclists | Roadie Labs",
    1499: "Cycling Nutrition Habits | Roadie Labs",
    1533: "Talent vs. Work in Cycling | Roadie Labs",
    1626: "Power Meter Mistakes | Roadie Labs",
    915: "Strength Training for Cyclists | Roadie Labs",

    # ── Blog Posts: Reviews & Analysis ──
    901: "WHOOP Review for Cyclists | Roadie Labs",
    1078: "Do You Need a Power Meter? | Roadie Labs",
    1186: "Why Did Tom Dumoulin Retire? | Roadie Labs",
    1230: "In Defense of FTP | Roadie Labs",
    1496: "How to Measure Cycling Fitness | Roadie Labs",
    4060: "FasCat AI Coaching Review | Roadie Labs",

    # ── Blog Posts: Culture & Philosophy ──
    922: "The Tao of Tom — Cycling Mentor | Roadie Labs",
    1673: "Sportsmanship in Gravel Racing | Roadie Labs",
    1879: "Humility Precedes Mastery | Roadie Labs",
    2345: "Gratitude in Cycling | Roadie Labs",
    2830: "Irony in Cycling Culture | Roadie Labs",
    2916: "End of Cycling Season | Roadie Labs",
    3581: "Cycling Work Ethic | Roadie Labs",
    3594: "Eight Years of Coaching Nate | Roadie Labs",
    3617: "Yoga for Cyclists | Roadie Labs",
    3694: "Lessons from Silver City | Roadie Labs",
    3791: "Stay Present on the Bike | Roadie Labs",
    3811: "Cycling Daily Habits | Roadie Labs",
    3825: "Cycling Injury Recovery | Roadie Labs",
    3945: "Cycling Motivation | Roadie Labs",
}
...
MANUAL_ENTRIES = [
    # ── Core Pages ──
    (448, "page", "home",
     "Road cycling data, coaching, and training plans. 427 gran fondos and sportives rated and ranked on 14 criteria. Built for cyclists who take road racing seriously.",
     "Road cycling data, coaching, and training plans. 427 gran fondos and sportives rated and ranked on 14 criteria.",
     "road cycling"),
    (451, "page", "contact",
     "Contact Roadie Labs with questions about races, training plans, coaching, or the race database. We respond to everything.",
     None, "contact road labs"),
    (470, "page", "the-ultimate-road-racing-guide",
     "The definitive road cycling guide: bike setup, training, nutrition, race strategy, and everything between the start and finish line.",
     None, "road cycling guide"),
    (5016, "page", "training-plans",
     "Road cycling training plans built for your goal race. 16-week periodized programs with race-specific prep. Data-driven. From $15/week.",
     "Road cycling training plans built for your goal race. 16-week periodized programs with race-specific prep.",
    ...
    (5018, "page", "road-races",
     "Search, filter, and compare 427 road races worldwide. Rated on 14 criteria including prestige, climbing, and logistics.",
     "Search and compare 427 road races worldwide. Rated on 14 criteria including prestige, climbing, and logistics.",
     "road races"),
    (5042, "page", "resources",
     "Road cycling resources: race calendars, training tools, nutrition calculators, and recommended gear from real experience.",
     None, "road cycling resources"),
    (5043, "page", "coaching",
     "Road cycling coaching: structured training, race strategy, and honest feedback from a real coach. Plans from $199 every 4 weeks.",
     "Road cycling coaching with structured training and race strategy. Plans from $199 every 4 weeks.",
     "road cycling coaching"),
    (5045, "page", "articles",
     "Road cycling articles: race reports, training insights, and analysis. First-person accounts from the start line to the finish.",
     None, "road cycling articles"),

    # ── Training Content Pages ──
    (5027, "page", "popular-training-plans",
     "Browse popular road cycling training plans by race. Gran fondos, sportives, centuries, and more. Each plan is race-specific.",
     None, "road cycling training plans"),
    ...
    (5024, "page", "articles-2",
     "Road cycling services: coaching, custom training plans, consulting, and race preparation for every level of cyclist.",
     None, "road cycling services"),
    (5025, "page", "road-labs-values",
     "Roadie Labs values: honest coaching, data-driven training, and respect for the athletes doing the actual work.",
     None, "road labs values"),
...
def validate_entries(entries):
    ...
    for e in entries:
        ...
        if not title.endswith("| Roadie Labs"):
            errors.append(f"Title missing '| Roadie Labs' suffix: wp_id={e['wp_id']} '{e['slug']}'")
