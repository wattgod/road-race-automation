...
def build_insights_css() -> str:
    ...
    return '''<style>
.rl-ins-breadcrumb,.rl-ins-hero,.rl-ins-section,.rl-ins-closing{max-width:1200px;margin:0 auto;padding-left:var(--rl-spacing-xl);padding-right:var(--rl-spacing-xl)}
...
.rl-ins-section{padding-top:var(--rl-spacing-3xl);padding-bottom:var(--rl-spacing-3xl);border-bottom:var(--rl-border-subtle)}.rl-ins-section--alt{max-width:none;background:var(--rl-color-silver);padding-left:max(var(--rl-spacing-xl),calc((100% - 1200px)/2 + var(--rl-spacing-xl)));padding-right:max(var(--rl-spacing-xl),calc((100% - 1200px)/2 + var(--rl-spacing-xl)))}
