#!/usr/bin/env python3
"""
Roadie Labs — Immune System digest email.
...
Env (.env or environment):
    ...
    DIGEST_FROM      sender    (default: immune@roadielabs.com — must be a Resend-verified domain)
...
def main() -> int:
    ...
    sender = os.environ.get("DIGEST_FROM", "immune@roadielabs.com")
    resp = requests.post(
