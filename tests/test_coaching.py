...
class TestHero:
    ...
    def test_stat_line(self):
        hero = build_hero()
        assert "427 road courses analyzed" in hero
        assert "One coach" in hero
        assert "rl-coach-stat-line" in hero
...
class TestFullBleedLayout:
    ...
    def test_bands_present(self, coaching_html):
        ...
        assert "rl-coach-band--sand" in coaching_html
...
class TestDeliverables:
    def test_four_deliverables(self):
        ...
        assert d.count('<div class="rl-coach-deliverable">') == 4

    def test_road_course_count(self):
        d = build_deliverables()
        assert "427 road courses" in d
...
class TestHowItWorks:
    def test_four_steps(self):
        ...
        assert h.count("rl-coach-step-num") == 4
...
class TestRequiredContent:
    def test_course_count(self, coaching_html):
        assert "427 road courses" in coaching_html
    ...
    def test_hero_h1(self, coaching_html):
        assert "Fitness is common. Preparation is rare." in coaching_html
